...
public class App extends Application {
    ...
    public void onCreate() {
        ...
        myClient = new Client.Builder(this.getApplicationContext())
        .setRetrieveUserCallback(new KinveyUserCallback<User>() {
            @Override
            public void onSuccess(User result) {
                Timber.i("ok, got success");
                if (App.getInstance().getClient() == null) { return; }
                if (!App.getInstance().getClient().isUserLoggedIn()) {
