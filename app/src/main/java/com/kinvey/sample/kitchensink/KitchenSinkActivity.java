 ...
 * @since 2.0
 */
public class KitchenSinkActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {

    private static final Level LOGGING_LEVEL = Level.FINEST;
    public static final String TAG = "KitchenSinkActivity";

    public static final String collectionName = "KitchenSinkActivity";
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        Client myClient = ((App)getApplication()).getClient();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menu_item_login:
                Client client = ((App)getApplicationContext()).getClient();
    ...
    private class FeatureAdapter extends ArrayAdapter<Loader.Feature> {
        ...
        public FeatureAdapter(Context context, List<Loader.Feature> objects, LayoutInflater inf) {
            ...
            super(context, R.layout.activity_feature, objects);
            this.mInflater = inf;
        }
