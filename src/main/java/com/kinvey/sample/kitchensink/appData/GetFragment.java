...
public class GetFragment extends UseCaseFragment implements View.OnClickListener {
    ...
    public void bindViews(View v) {
        ...
        viewingID.setAdapter(new ArrayAdapter<String>(getActivity(), android.R.layout.simple_spinner_dropdown_item, new String[]{"--"}));
    ...
    private void updateSpinner(MyEntity[] result) {
        ...
        viewingID.setAdapter(new ArrayAdapter<String>(getActivity(), android.R.layout.simple_spinner_dropdown_item, ids));
