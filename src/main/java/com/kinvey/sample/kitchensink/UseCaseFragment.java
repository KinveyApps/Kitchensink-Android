 ...
 * @since 2.0
 */
public abstract class UseCaseFragment extends Fragment {
    ...
    public KitchenSinkApplication getApplicationContext(){
        return ((FeatureActivity) getActivity()).getApplicationContext();
    }
    ...
    public Client getClient(){
        return ((FeatureActivity)getActivity()).getClient();
